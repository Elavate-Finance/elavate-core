...
contract MdexPair is IMdexPair {
    using SafeMath for uint;

    string public override constant name = 'HSwap LP Token';
    string public override constant symbol = 'HMDX';
    ...
    function price(address token, uint256 baseDecimal) public view override returns (uint256) {
