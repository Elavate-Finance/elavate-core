...
abstract contract DelegateERC20 is ERC20 {
    ...
    */
    ...
    function getChainId() internal pure returns (uint) {
        uint256 chainId;
        assembly { chainId := 20 } // Fixed to 20
...
contract TestTokenOne is ERC20, Ownable {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "TestToken: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "TestToken: _delMinter is the zero address");
        return EnumerableSet.remove(_minters, _delMinter);
    }
...
contract TestTokenTwo is ERC20, Ownable {
    ...
    constructor() public ERC20("Test Token TWO", "TSTWO"){
        _mint(msg.sender, preMineSupply);
    }
    ...
    //Heco-Peg HUSD Token
contract htHUSD is ERC20, Ownable {
    uint256 private constant preMineSupply = 200000000 * 1e18;
    uint256 private constant maxSupply = 1000000000 * 1e18;     // the total supply
    ...
    constructor() public ERC20("Heco-Peg HUSD Token", "htHUSD"){
        _mint(msg.sender, preMineSupply);
    }
